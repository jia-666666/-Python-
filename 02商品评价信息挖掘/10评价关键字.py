...
# 设置标题
plt.xlabel("评价", fontproperties='SimHei', size=12)
plt.ylabel("统计", fontproperties='SimHei', rotation=90, size=12)
plt.title("评价词频统计关系图", fontproperties='SimHei', size=16)
#倾斜度角
...
plt.grid(linestyle='-.')
plt.savefig('../file/PNG/18评价词频关系图.png')
plt.show()
