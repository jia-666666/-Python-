...
def get_search_URL(key):
    ...
    print('三 搜素链接已生成')
    url='https://list.tmall.com/search_product.htm?spm=a220m.1000858.0.0.73fd4227fQA6b8&s=60&q=%D6%C7%C4%DC%CA%D6%BB%FA&sort=s&style=g&from=mallfp..pc_1_searchbutton&active=2&type=pc#J_Filter'
    with open('../file/CSV/手机_评价1.csv', 'a+', encoding='utf-8') as f:
