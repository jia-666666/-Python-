...
def sort(auctionSku,ratecontent,ratedate):
    #print('格式整理')
    # print(auctionSku)
    # print(type(ratecontent))
    # print(ratecontent)
    # print(type(auctionSku))
    # print(ratedate)
    # print(type(ratedate))
    for i in range(0, len(auctionSku)):  # 遍历该评价页的所有条目
        ...
        content = str(ratecontent[i]).replace('，', '.').replace(' ','')  # 获取第i个评价内容
...
if __name__ == '__main__':
    ...
    URL='https://list.tmall.com/search_product.htm?spm=a220m.1000858.0.0.73fd4227p1qiJn&s=60&q=%D6%C7%C4%DC%CA%D6%BB%FA&sort=s&style=g&from=mallfp..pc_1_searchbutton&active=2&type=pc#J_Filter'
